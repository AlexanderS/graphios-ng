...
class call_later:
    ...
    def __init__(self, seconds, target, *args, **kwargs):
        ...
        assert sys.maxsize >= seconds >= 0, "%s is not greater than or " \
                                            "equal to 0 seconds" % seconds
        self._delay = seconds
        self._target = target
        self._args = args
        self._kwargs = kwargs
    ...
    def cancel(self):
        ...
        if self in _tasks:
            ...
            if pos == 0:
                ...
                heapq._siftup(_tasks, pos)  # pylint: disable=W0212


class call_every(call_later):
    """
